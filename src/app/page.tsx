                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div className="mt-4 p-4 rounded-lg bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-amber-800 dark:text-amber-200 mb-2">Windows 用户注意</div>
                          <p className="text-amber-700 dark:text-amber-300 mb-3">
                            由于应用未购买商业签名证书，Windows SmartScreen 可能会阻止运行。请按以下步骤操作：
                          </p>
                          <div className="space-y-2 text-amber-700 dark:text-amber-300">
                            <div className="flex items-start gap-2">
                              <span className="font-mono bg-amber-100 dark:bg-amber-900 px-1.5 py-0.5 rounded text-xs">方法1</span>
                              <span>点击「更多信息」→「仍要运行」</span>
                            </div>
                            <div className="flex items-start gap-2">
                              <span className="font-mono bg-amber-100 dark:bg-amber-900 px-1.5 py-0.5 rounded text-xs">方法2</span>
                              <span>右键安装包 → 属性 → 勾选「解除锁定」</span>
                            </div>
                            <div className="flex items-start gap-2">
                              <span className="font-mono bg-amber-100 dark:bg-amber-900 px-1.5 py-0.5 rounded text-xs">方法3</span>
                              <span>以管理员身份运行 PowerShell：<br/>
                                <code className="text-xs bg-amber-100 dark:bg-amber-900 px-1.5 py-0.5 rounded">Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser</code>
                              </span>
                            </div>
                          </div>
                          <p className="mt-3 text-xs text-amber-600 dark:text-amber-400">
                            💡 这是开源软件的常见问题，应用代码完全开源可审计，请放心使用。
                          </p>
                        </div>
                      </div>
                    </div>
